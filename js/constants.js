...
const PTERODACTYL_SPEED_OFFSET = 2.5; // Extra speed towards player  // score at which obstacle pairs appear
...
const SKINS = [
  { 
    id: 'backpack', 
    name: 'Z plecakiem',    
    colors: { body: '#3a7bd5', pants: '#5a5a8a', skin: '#f5c5a3', hair: '#3d2b1f', extra: '#8B4513' },
    w: 60, h: 75, 
    hit: { x: 10, y: 6, w: 40, h: 63 },
    duckH: 50, duckHit: { x: 8, y: 6, w: 44, h: 38 }
  },
  { 
    id: 'varsity',  
    name: 'Gwiazda sportu', 
    colors: { body: '#c0392b', pants: '#5a5a8a', skin: '#f5c5a3', hair: '#2c1810', extra: '#f39c12' },
    w: 60, h: 75, 
    hit: { x: 10, y: 6, w: 40, h: 63 },
    duckH: 50, duckHit: { x: 8, y: 6, w: 44, h: 38 }
  },
  { 
    id: 'hoodie',   
    name: 'W bluzie',      
    colors: { body: '#f39c12', pants: '#455a64', skin: '#f5c5a3', hair: '#5d4037', extra: '#78909c' },
    w: 60, h: 75, 
    hit: { x: 10, y: 6, w: 40, h: 63 },
    duckH: 50, duckHit: { x: 8, y: 6, w: 44, h: 38 }
  },
  { 
    id: 'dino',     
    name: 'Klasyczny Dino', 
    colors: { body: '#4caf50', pants: '#388e3c', skin: '#81c784', hair: '#2e7d32', extra: '#a5d6a7' },
    w: 80, h: 80, 
    hit: { x: 8, y: 8, w: 64, h: 68 },
    duckH: 55, duckHit: { x: 6, y: 10, w: 68, h: 40 }
  },
];
